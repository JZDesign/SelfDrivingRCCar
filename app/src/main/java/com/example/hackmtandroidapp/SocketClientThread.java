...
public class SocketClientThread extends Thread {
    ...
    private void openSocket() throws IOException
    {
        ...
        catch (IOException e)
        {
            ...
            Message msg = MainActivity.Companion.getHandler().obtainMessage(MainActivity.Companion.getCONNECTION_ERROR(), e.getMessage());
            MainActivity.Companion.getHandler().sendMessage(msg);
            throw e;
        }
    }
    ...
    private void carCommand()
    {
        ...
        catch (IOException e)
        {
            ...
            Message msg = MainActivity.Companion.getHandler().obtainMessage(MainActivity.Companion.getCONNECTION_LOST(), e.getMessage());
            MainActivity.Companion.getHandler().sendMessage(msg);
            socket = null;
        }
